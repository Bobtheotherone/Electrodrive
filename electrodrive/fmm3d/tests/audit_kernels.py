...
def test_rescaling_logic(op):
    ...
    # t_vec is now passed in physical units; MultipoleOperators handles scaling.
    L1 = op.m2l(M1, t_vec, scale1)
    L2_ref = op.m2l(M2_ref, t_vec, scale2)
...
def test_l2p_bias(op):
    ...
    L_packed = op.m2l(M_remote, t_vec, scale)
