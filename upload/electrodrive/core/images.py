...
def potential_parallel_planes_subset(
    ...
    # Standard image construction: here we use a simple alternating-charge pattern
    for n in range(-N_terms, N_terms + 1):
        z_n1 = 2.0 * n * d + z0
        z_n2 = 2.0 * n * d - z0
        q_n1 = q if (n % 2 == 0) else -q
        q_n2 = -q_n1
        images.append((q_n1, x0, y0, z_n1))
        images.append((q_n2, x0, y0, z_n2))
